...
class PositionPublisher(object):
    ...
    def handle_uav_status(self, uavStatus):
        """
        Handle HAL callback
        """
        self._msender.send_message( self._createUavState(uavStatus) )
    ...
    def _createUavState(self, uavStatus):
        msg = Json.boatStatus2Json(uavStatus)
        return msg